var VueTrix = function (e, t) {
  ...
  var n = {
    ...
    mixins: [{
      ...
      methods: {
        emitAttachmentAdd: function (e) {
          this.$emit("trix-attachment-add", e)
        }
      }
    }, {
      methods: {
        emitSelectionChange: function (e) {
          this.$emit("trix-selection-change", this.$refs.trix.editor, e)
        }
      }
    }, {
      methods: {
        emitAttachmentRemove: function (e) {
          this.$emit("trix-attachment-remove", e)
        }
      }
    }, {
      methods: {
        emitBeforeInitialize: function (e) {
          this.$emit("trix-before-initialize", this.$refs.trix.editor, e)
        }
      }
    }, {
      methods: {
        processTrixFocus: function (e) {
          this.$refs.trix && (this.isActived = !0, this.$emit("trix-focus", this.$refs.trix.editor, e))
        }, processTrixBlur: function (e) {
          this.$refs.trix && (this.isActived = !1, this.$emit("trix-blur", this.$refs.trix.editor, e))
        }
      }
    }],
    model: {prop: "srcContent", event: "update"},
    props: {
      disabledEditor: {
        type: Boolean, required: !1, default: function () {
          return !1
        }
      }, inputId: {
    ...
    mounted: function () {
      var t = this;
      this.overrideConfig(this.config), this.decorateDisabledEditor(this.disabledEditor), this.$nextTick(function () {
        if (t.localStorage) {
          var e = localStorage.getItem(t.storageId("VueTrix"));
          e && !t.srcContent && t.$refs.trix.editor.loadJSON(JSON.parse(e))
        }
      })
    },
    data: function () {
      return {editorContent: this.srcContent, isActived: null}
    },
    methods: {
      handleContentChange: function (e) {
        this.editorContent = e.srcElement ? e.srcElement.value : e.target.value, this.$emit("input", this.editorContent)
      }, handleInitialize: function () {
        this.autofocus && this.$refs.trix.editor.setSelectedRange(0), this.$emit("trix-initialize", this.emitInitialize)
      }, handleInitialContentChange: function (e) {
        e = void 0 === e ? "" : e, this.$refs.trix.editor && this.$refs.trix.editor.innerHTML !== e && (this.editorContent = e, this.isActived || this.reloadEditorContent(this.editorContent))
      }, emitEditorState: function () {
        this.localStorage && localStorage.setItem(this.storageId("VueTrix"), JSON.stringify(this.$refs.trix.editor)), this.$emit("update", this.editorContent)
      }, storageId: function (e) {
        return this.inputId ? e + "." + this.inputId + ".content" : e + ".content"
      }, reloadEditorContent: function (e) {
        this.$refs.trix.editor.loadHTML(e), this.$refs.trix.editor.setSelectedRange(this.getContentEndPosition())
      }, getContentEndPosition: function () {
        return this.$refs.trix.editor.getDocument().toString().length - 1
      }, decorateDisabledEditor: function (e) {
        e ? (this.$refs.trix.toolbarElement.style["pointer-events"] = "none", this.$refs.trix.contentEditable = !1, this.$refs.trix.style.background = "#e9ecef") : (this.$refs.trix.toolbarElement.style["pointer-events"] = "unset", this.$refs.trix.style["pointer-events"] = "unset", this.$refs.trix.style.background = "transparent")
      }, overrideConfig: function (e) {
        t.config = this.deepMerge(t.config, e)
      }, deepMerge: function (e, t) {
        for (var n in t) t.hasOwnProperty(n) && ("[object Object]" === Object.prototype.toString.call(t[n]) ? e[n] = this.deepMerge(e[n], t[n]) : e[n] = t[n]);
        return e
      }
    },
    computed: {
    ...
    watch: {
      editorContent: {handler: "emitEditorState"},
      initialContent: {handler: "handleInitialContentChange"},
      isDisabled: {handler: "decorateDisabledEditor"},
      config: {handler: "overrideConfig", deep: !0}
    }
  };

  function i(e, t, n, i, r, o, s, a, d, c) {
    "boolean" != typeof s && (d = a, a = s, s = !1);
    var l, u = "function" == typeof n ? n.options : n;
    if (e && e.render && (u.render = e.render, u.staticRenderFns = e.staticRenderFns, u._compiled = !0, r && (u.functional = !0)), i && (u._scopeId = i), o ? (l = function (e) {
      (e = e || this.$vnode && this.$vnode.ssrContext || this.parent && this.parent.$vnode && this.parent.$vnode.ssrContext) || "undefined" == typeof __VUE_SSR_CONTEXT__ || (e = __VUE_SSR_CONTEXT__), t && t.call(this, d(e)), e && e._registeredComponents && e._registeredComponents.add(o)
    }, u._ssrRegister = l) : t && (l = s ? function (e) {
  ...
  var d, c = "undefined" != typeof navigator && /msie [6-9]\\b/.test(navigator.userAgent.toLowerCase());

  function r(e) {
    return function (e, t) {
      return function (e, t) {
        var n = c ? t.media || "default" : e, i = l[n] || (l[n] = {ids: new Set, styles: []});
        if (!i.ids.has(e)) {
          i.ids.add(e);
          var r = t.source;
          if (t.map && (r += "\n/*# sourceURL=" + t.map.sources[0] + " */", r += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(t.map)))) + " */"), i.element || (i.element = document.createElement("style"), i.element.type = "text/css", t.media && i.element.setAttribute("media", t.media), void 0 === d && (d = document.head || document.getElementsByTagName("head")[0]), d.appendChild(i.element)), "styleSheet" in i.element) i.styles.push(r), i.element.styleSheet.cssText = i.styles.filter(Boolean).join("\n"); else {
            var o = i.ids.size - 1, s = document.createTextNode(r), a = i.element.childNodes;
            a[o] && i.element.removeChild(a[o]), a.length ? i.element.insertBefore(s, a[o]) : i.element.appendChild(s)
          }
        }
      }(e, t)
    }
  ...
  function o() {
    ...
    return n("div", {class: [e.$style.trix_container]}, [n("trix-editor", {
      ref: "trix",
      class: ["trix-content"],
      attrs: {contenteditable: !e.disabledEditor, input: e.computedId, placeholder: e.placeholder},
      on: {
        "trix-change": e.handleContentChange,
        "trix-file-accept": e.emitFileAccept,
        "trix-attachment-add": e.emitAttachmentAdd,
        "trix-attachment-remove": e.emitAttachmentRemove,
        "trix-selection-change": e.emitSelectionChange,
        "trix-initialize": e.handleInitialize,
        "trix-before-initialize": e.emitBeforeInitialize,
        "trix-focus": e.processTrixFocus,
        "trix-blur": e.processTrixBlur
      }
    }), e._v(" "), n("input", {
      attrs: {type: "hidden", name: e.inputName, id: e.computedId},
      domProps: {value: e.editorContent}
    })], 1)
  }

  var s = n, a = (o._withStripped = !0, i({render: o, staticRenderFns: []}, function (e) {
    e && (e("data-v-501b9774_0", {
      ...
      map: {
        ...
        names: [],
        mappings: ";AA2SA;EACA,eAAA;EACA,YAAA;AACA;AACA;EACA,uBAAA;AACA;AACA;EACA,uBAAA;AACA",
        file: "VueTrix.vue",
  ...
  }, s, void 0, !1, void 0, !1, r, void 0, void 0));
  return e.config.ignoredElements = ["trix-editor"], e.component(a.name, a), a
}(Vue, Trix);
