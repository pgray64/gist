...
parasails.registerComponent('cloud-error', {
  ...
  template: `
  <div>
    <p :class="{ 'm-0': beWithoutMargins }" class="text-danger"><slot name="default">An error occurred while processing your request. Please check your information and try again, or contact support if the error persists.</slot></p>
  </div>
  `,
